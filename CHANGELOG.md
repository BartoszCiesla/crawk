...
- *(check)* Freeze existing cycles in --init scaffold - ([3b06e6d](https://github.com/BartoszCiesla/crawk/commit/3b06e6dfcc19e13c62892efcbdd9114c5a8586c2))
...
- *(rules)* Add restrict rule for allowed dependency targets - ([bc6ea8e](https://github.com/BartoszCiesla/crawk/commit/bc6ea8e6172e00fcfeb5d874cba8ff967da9b359))
- *(rules)* Add deny-cycles rule with cycle allowlist - ([30cb577](https://github.com/BartoszCiesla/crawk/commit/30cb577b55d89059b1dee074dbc6c608614e1fef))
...
- *(analyzer)* Surface real errors from non-recursive discovery - ([42eac58](https://github.com/BartoszCiesla/crawk/commit/42eac58a351e849193f5d91525416b93ce23ede2))
...
- *(cli)* Reject single-colon module path separators - ([ee6813d](https://github.com/BartoszCiesla/crawk/commit/ee6813d6550197d9020551280abc03ca22666c6a))
- *(cli)* Keep deps --path lookup at full module granularity - ([8ceb367](https://github.com/BartoszCiesla/crawk/commit/8ceb3670092df3e1992953cee8735ea9eb54a2b8))
- *(cli)* Map pre-dispatch check errors to exit code 2 - ([a568474](https://github.com/BartoszCiesla/crawk/commit/a568474aba30e7c86e0627cd24f9df715355573d))
- *(discover)* Peel inline-scope prefixes shortest-first - ([d268475](https://github.com/BartoszCiesla/crawk/commit/d26847546f50c4faf453f2ae47ac18de112b2ccc))
- *(discover)* Enforce file-size limit on the discovery read path - ([d4c1d38](https://github.com/BartoszCiesla/crawk/commit/d4c1d386bea2bd62d7ec928002ecec82eb580b9b))
...
- *(logger)* Gate ANSI colors on TTY detection and NO_COLOR - ([20a02d0](https://github.com/BartoszCiesla/crawk/commit/20a02d0208fa363e183e5c705e66476723419db7))
- *(logger)* Route console tracing logs to stderr - ([6a893da](https://github.com/BartoszCiesla/crawk/commit/6a893daa3ac1767f0244044914f2b0906b547f77))
- *(parser)* Error on unresolved inline scope instead of silent empty - ([0562752](https://github.com/BartoszCiesla/crawk/commit/0562752d346bc386d4a28afaa0f05b69fb578f4c))
- *(parser)* Visit qself type path only once - ([f4c1847](https://github.com/BartoszCiesla/crawk/commit/f4c184752ba8f816a41e6fb76346789e3fb1a9f1))
...
- *(graph)* Move path truncation out of the binary into lib - ([a69f1ba](https://github.com/BartoszCiesla/crawk/commit/a69f1ba4fcb915ff3fdefff0492885e1710a641a))
- *(module_path)* Unify subtree and parent-path predicates - ([2578161](https://github.com/BartoszCiesla/crawk/commit/25781611a9de91be1db6e30ae8c639c2bb0333f0))
- *(parser)* Unify path-prefix parsing in one splitter - ([e301bc9](https://github.com/BartoszCiesla/crawk/commit/e301bc93d88ba57e0f186b92e1d5623fb9c3f51d))
...
- Document restrict rules - ([b51077d](https://github.com/BartoszCiesla/crawk/commit/b51077dad380efa8f2f1dd0f61d96e75fab82c59))
- Document deny-cycles and the cycle allowlist - ([e75da03](https://github.com/BartoszCiesla/crawk/commit/e75da03e8e7bc60784ce85f6870791dfc2aeaef9))
...
- *(discover)* Memoize module resolution and root canonical path - ([8e94af4](https://github.com/BartoszCiesla/crawk/commit/8e94af438d528fd9429d93c723cf23b629fcc1b9))
- *(discover)* Cache root package index to avoid per-call scan - ([8ca9b12](https://github.com/BartoszCiesla/crawk/commit/8ca9b12a4feb5243fb567ddad17e1370b98ba34f))
- *(discover)* Thread ParseCache through inline module resolution - ([4d12591](https://github.com/BartoszCiesla/crawk/commit/4d125918948ae1bed70aa12e5e5f34fcf0ecf038))
...
- *(parser)* Move refs out of visitor instead of cloning - ([ca6724e](https://github.com/BartoszCiesla/crawk/commit/ca6724ec3c9cb0b6a7e614fe0865d458c14c0f85))
- *(parser)* Return borrowed refs from parse_file - ([1df782a](https://github.com/BartoszCiesla/crawk/commit/1df782a7075d52a43a39e177b26892733572e3b8))
...
- *(check)* Cover deny-cycles and allow-cycle end-to-end - ([a455d85](https://github.com/BartoszCiesla/crawk/commit/a455d854290b03b4690bdf20d6a4e00d855e371f))
- *(cli)* Assert Display matches ValueEnum for output formats - ([c65eafe](https://github.com/BartoszCiesla/crawk/commit/c65eafe9bd9df3ec6778313f7f024005ca81df9a))

### ⚙️ Miscellaneous Tasks


- *(check)* Tighten bin-side contract with restrict rules - ([3ece5ff](https://github.com/BartoszCiesla/crawk/commit/3ece5ff3d82eb1ed60d26d033d99a96db2914e1c))
- *(lints)* Add clippy restriction lints and fix violations - ([a002a8d](https://github.com/BartoszCiesla/crawk/commit/a002a8d28c26bfc16bb7c2dccb46c503a5c39e0a))
